...
import 'package:cost_tracker_app/src/pages/transaction/edit/transaction_edit_controller.dart';
import 'package:cost_tracker_app/src/utils/my_colors.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';

class TransactionEditPage extends StatefulWidget {
  const TransactionEditPage({Key? key}) : super(key: key);
...
class _TransactionEditPageState extends State<TransactionEditPage> {
  ...
  TransactionEditController _conTransaction = new TransactionEditController();
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    final String transId = arguments['transId'];
    ...
    if(_conTransaction.isInitialize==true){
      _conTransaction.initializeCategories(typeId: typeId.toString());
      _conTransaction.initializeTransaction(transId,nameType);
    }
    return Scaffold(
      key: _con.key,
      appBar: AppBar(
  ...
  Widget _contentTransaction(String nameType){
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            SizedBox(height: 80,),
            _dataTransaction(nameType)
          ],
        ),
      ),
    );
  }
  Widget _dataTransaction(String nameType){
    return Container(
      height: 600,
      ...
      child: Column(
        ...
        children: [
          ...
          _textFieldTypeTransaction(nameType),
          SizedBox(height: 20),
          _buttonCreate(),
        ],
      ),
  ...
  Widget _textFieldTypeTransaction(String nameType){
    return Column(
      children: [
        Container(
  ...
  Widget _buttonCreate(){
    return Container(
      ...
      child: ElevatedButton(
        onPressed:_conTransaction.update,
        child: Text('Editar Transaccion'),
